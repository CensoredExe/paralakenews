        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 pt-3 px-4">
          ...
          <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="text" name="description" class="form-control" id="description" aria-describedby="emailHelp" placeholder="title">
                
            </div>
            <div class="form-group">
                <label for="url">URL, format like this test-title-example</label>
                <input type="text" name="url" class="form-control" id="url" aria-describedby="emailHelp" placeholder="title">
