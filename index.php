...
<div class="container">
  <header class="blog-header py-3">
    <div class="row flex-nowrap justify-content-between align-items-center">
      <div class="col-4 pt-1">
        <a class="text-muted" href="#">Apply</a>
      </div>
      ...
      <div class="col-4 d-flex justify-content-end align-items-center">
        ...
        <a class="btn btn-sm btn-outline-secondary" href="#">Steam Login</a>
      </div>
    </div>
  </header>
  ...
  <div class="nav-scroller py-1 mb-2">
    <nav class="nav d-flex justify-content-between">
      ...
      <a class="p-2 text-muted" href="#">PLPD</a>
      <a class="p-2 text-muted" href="#">Staff</a>
      <a class="p-2 text-muted" href="#">Crime</a>
      <a class="p-2 text-muted" href="#">Development</a>
      <a class="p-2 text-muted" href="#">Organisations</a>
      <a class="p-2 text-muted" href="#">Forums</a>
  ...
  <div class="jumbotron p-4 p-md-5 text-white rounded bg-dark featured-post">
    <div class="col-md-6 px-0">
      ...
      <h1 class="display-4 font-italic">Crime on the increase as gangs grow</h1>
      <strong class="d-inline-block mb-2 text-danger">Crime</strong>
  ...
  <div class="row mb-2">
    ...
    <div class="col-md-6">
      <div class="row no-gutters border rounded overflow-hidden flex-md-row mb-4 shadow-sm position-relative">
        <div class="col p-4 d-flex flex-column position-static">
          <strong class="d-inline-block mb-2 text-success">Staff</strong>
          <h3 class="mb-0">Staff member demoted</h3>
...
<main role="main" class="container">
  <div class="row">
    <div class="col-md-8 blog-main">
      ...
      <div class="blog-post">
        <h2 class="blog-post-title">Senior Administration takes on two new helpers</h2>
